...
class Estacionamiento(models.Model):
    ...
    class Meta:
        managed = True
        db_table = 'sadicarnot_estacionamiento'
...
class Cuota(models.Model):
    ...
    situacion = models.ForeignKey(Situacion, related_name='sadi_cuota_situacion_id')
    tipo_cuota = models.ForeignKey(TipoCuota, related_name='sadi_cuota_tipo_cuota_id')
    condomino = models.ForeignKey(Condomino, related_name='sadi_condomino_id')
    ...
    class Meta:
        managed = True
        db_table = 'sadicarnot_cuota'

class Recibo(models.Model):
    folio = models.IntegerField(blank=False, null=False)
    fecha = models.DateField()
    condomino = models.ForeignKey(Condomino, related_name='sadi_recibo_condomino_id')
