...
class Cuota(models.Model):
    ...
    situacion = models.ForeignKey(Situacion, related_name='olimpo_cuota_situacion_id')
    tipo_cuota = models.ForeignKey(TipoCuota, related_name='olimpo_cuota_tipo_cuota_id')
    condomino = models.ForeignKey(Condomino, related_name='olimpo_cuota_condomino_id')
    ...
    class Meta:
        managed = True
        db_table = 'olimpo_cuota'

class Recibo(models.Model):
    folio = models.IntegerField(blank=False, null=False)
    fecha = models.DateField()
    condomino = models.ForeignKey(Condomino, related_name='olimpo_recibo_condomino_id')
    ...
    cuota = models.ManyToManyField(Cuota, related_name='olimpo_recibo_cuota_id')

    class Meta:
        managed = True
        db_table = 'olimpo_recibo'

class Movimiento(models.Model):
    cuenta = models.ForeignKey(Cuenta, related_name='olimpo_movimiento_cuenta_id')
    ...
    recibo = models.ManyToManyField(Recibo, related_name='olimpo_movimiento_recibo_id')
